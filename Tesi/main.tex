...
Il risultato medio ottenuto sulle 50 canzoni, per ogni utente e configurazione, è riportato rispettivamente nelle tabelle 6.1 e \ref{tab4}. I risultati sono visibili in forma grafica nelle figure \ref{fig-data1} e \ref{fig-data2}. 



\begin{figure}[h]
\centering
\includegraphics[scale = 0.9]{img/grafico-tab3.png}
